...
git clone -b v5.3.9 https://github.com/aircrack-ng/rtl8188eus "$wd/8188eu"
git clone -b master https://github.com/pvaret/rtl8192cu-fixes "$wd/8192cu"
...
echo "obj-\$(CONFIG_8188EU) += 8188eu/" >> "$wd/Makefile"
echo "obj-\$(CONFIG_8192CU) += 8192cu/" >> "$wd/Makefile"
...
source "drivers/net/wireless/realtek/8188eu/Kconfig"
source "drivers/net/wireless/realtek/8192cu/Kconfig"
